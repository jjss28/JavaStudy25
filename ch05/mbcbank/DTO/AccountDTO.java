...
public class AccountDTO {
	...
	// 생성자
	public AccountDTO(String ano, String owner, int balance, String bankname) {// source ->generate using fields
		// super();
		this.ano = ano;
		this.owner = owner;
	...
	public String getAno() { // source -> generate getter and setter
		// 계좌번호 출력시 변조를 담당한다.
		return ano;
	}
